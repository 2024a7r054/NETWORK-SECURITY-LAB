...
6. Compare the original and modified hashes character by character and count the differing hash characters.
   ...
   ![SHA-256 Hash Output](Outputs/sha256.jpg)
...
Added user input to make the program more interactive and easier to use.
The program also compares the original and modified SHA-256 hashes to detect any changes in the file.
## Conclusion
